        ...
        const postHTML = `
          <div class="post">
            <div class="post-metadata">
              ...
              <p class="post-author-name">${post.professor_name}</p>
              <p class="post-date">${post.discipline_code} ${post.department_name}</p>
            </div>
            <p class="post-text-content">Professor de ${post.discipline_name} da Turma ${post.turma_id}.</p>
